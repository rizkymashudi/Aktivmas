...
@section('content')
    <div class="card">
        <div class="card-header">
            <strong>Tambah jadwal kegiatan</strong>
        </div>
        <div class="card-body card-block">
            <form action="{{ route('activities.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea class="form-control ckeditor @error('activity_detail') is-invalid @enderror" name="activity_detail" value="{{ old('activity_detail') }}" cols="120" rows="10"></textarea>
