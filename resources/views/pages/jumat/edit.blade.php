...
@section('content')
    <div class="card">
        <div class="card-header">
            <strong>Edit Jadwal khotbah jumat</strong>
        </div>
        <div class="card-body card-block">
            <form action="{{ route('jumat.update', $khotib->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @method('PUT')
                @csrf
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="text" 
                                ...
                                value="{{ old('name') ? old('name') : $khotib->name }}"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="date" 
                                ...
                                value="{{ old('date') ? old('date') : $khotib->date }}"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="time" 
                                ...
                                value="{{ old('time_khotbah') ? old('time_khotbah') : $khotib->time_khotbah }}"
