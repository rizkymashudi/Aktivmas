            ...
            <div class="card">
                <div class="card-body">
                    <div class="stat-widget-five">
                        ...
                        <div class="stat-content">
                            <div class="text-left dib">
                                <div class="stat-text">Rp. <span class="count">{{ $totalDebet }}</span></div>
                                <div class="stat-heading">Total debet</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="stat-widget-five">
                        ...
                        <div class="stat-content">
                            <div class="text-left dib">
                                <div class="stat-text">Rp. <span class="count">{{ $totalKredit }}</span></div>
                                <div class="stat-heading">Total kredit</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="orders">
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-title">Kas Masjid Agung Batam Bulan {{ now()->format('F') }} </h4>
                    </div>
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h m-4">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th>
